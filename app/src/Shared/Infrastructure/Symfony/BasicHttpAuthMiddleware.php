...
use Base\Backoffice\Auth\Application\Authenticate\AuthenticateUserCommand;
use Base\Backoffice\Auth\Domain\InvalidAuthCredentials;
use Base\Backoffice\Auth\Domain\InvalidAuthUsername;
