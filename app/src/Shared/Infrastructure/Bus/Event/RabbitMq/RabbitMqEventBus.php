...
namespace Base\Shared\Infrastructure\Bus\Event\RabbitMq;

use AMQPException;
use Base\Shared\Domain\Bus\Event\DomainEvent;
use Base\Shared\Domain\Bus\Event\EventBus;
use Base\Shared\Infrastructure\Bus\Event\DomainEventJsonSerializer;
use Base\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineEventBus;
