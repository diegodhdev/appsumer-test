...
namespace Base\Shared\Infrastructure\Bus\Event;

use Base\Shared\Domain\Bus\Event\DomainEventSubscriber;
use Base\Shared\Infrastructure\Bus\CallableFirstParameterExtractor;
use Base\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqQueueNameFormatter;
