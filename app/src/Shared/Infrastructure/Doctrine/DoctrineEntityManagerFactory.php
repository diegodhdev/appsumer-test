...
use Base\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static array $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Base\Shared\Domain',
    ];
    ...
    {
        // ArrayCache it will be generated in each cycle lifetime Request - Response. If we want to persist the connection for reuse in future cycles lifetime we can research about APCu Cache
